...
/**
 * Capability definitions for the workshep module
 *
...
$capabilities = array(
    ...
    // Ability to see that the workshep exists, and the basic information
    // about it, for example the intro field
    'mod/workshep:view' => array(
        'captype' => 'read',
    ...
    // Ability to add a new workshep to the course.
    'mod/workshep:addinstance' => array(
    ...
    // Ability to change the current phase (stage) of the workshep, for example
    // allow submitting, start assessment period, close workshep etc.
    'mod/workshep:switchphase' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/workshep:editdimensions' => array(
    ...
    // in the workshep as the authors
    'mod/workshep:submit' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/workshep:manageexamples' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    // Ability to publish submissions, i.e. make them available when workshep is closed
    'mod/workshep:publishsubmissions' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/workshep:viewauthornames' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/workshep:viewreviewernames' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/workshep:viewallsubmissions' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    // Ability to view published submission when the workshep is closed. Group mode
    // restrictions do not apply here, published submissions are available in all
    // groups even in the separate groups mode.
    'mod/workshep:viewpublishedsubmissions' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/workshep:viewauthorpublished' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/workshep:viewallassessments' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
