...
/**
 * Unit tests for mod/workshep/lib.php.
 *
...
class mod_workshep_lib_testcase extends advanced_testcase {
     ...
     */
    public function test_workshep_core_calendar_provide_event_action_open_for_non_user() {
        global $CFG;
     ...
     */
    public function test_workshep_core_calendar_provide_event_action_open_for_user() {
        global $CFG;
     ...
     */
    public function test_workshep_core_calendar_provide_event_action_closed_for_non_user() {
        global $CFG;
     ...
     */
    public function test_workshep_core_calendar_provide_event_action_closed_for_user() {
        global $CFG;
     ...
     */
    public function test_workshep_core_calendar_provide_event_action_open_in_future_for_non_user() {
        global $CFG;
     ...
     */
    public function test_workshep_core_calendar_provide_event_action_open_in_future_for_user() {
        global $CFG;
     ...
     */
    public function test_workshep_core_calendar_provide_event_action_no_time_specified_for_non_user() {
        global $CFG;
    ...
    public function test_workshep_core_calendar_provide_event_action_already_completed() {
        $this->resetAfterTest();
    ...
    public function test_workshep_core_calendar_provide_event_action_already_completed_for_user() {
        $this->resetAfterTest();
        set_config('enablecompletion', 1);
        $this->setAdminUser();
     ...
     * @param int $instanceid The workshep id.
     * @param string $eventtype The event type. eg. WORKSHEP_EVENT_TYPE_OPEN.
    ...
    public function test_check_updates_since() {
        ...
        $updates = workshep_check_updates_since($cm, $onehourago);
        ...
        // Submission.
        $submissionid = $generator->create_submission($workshep->id, $student->id, array(
     ...
     */
    public function test_mod_workshep_core_calendar_get_valid_event_timestart_range_unknown_event() {
        global $CFG;
     ...
     */
    public function mod_workshep_core_calendar_get_valid_event_timestart_range_due_no_limit_provider() {
        $submissionstart = time() + DAYSECS;
     ...
     */
    public function test_mod_workshep_core_calendar_event_timestart_updated_unknown_event() {
        global $CFG, $DB;
        require_once($CFG->dirroot . "/calendar/lib.php");
     ...
     */
    public function mod_workshep_core_calendar_event_timestart_updated_provider() {
        $submissionstart = time() + DAYSECS;
        $submissionend = $submissionstart + DAYSECS;
        $assessmentstart = $submissionend + DAYSECS;
        $assessmentend = $assessmentstart + DAYSECS;
