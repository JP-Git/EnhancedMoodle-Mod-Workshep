...
Feature: Submission types
  ...
  Scenario: Test workshep settings validation
    ...
    And I add a "Workshep" to section "0"
    ...
    And I press "Save and display"
    Then I should see "Setup phase" in the "h3#mod_workshep-userplanheading" "css_element"
  ...
  Scenario: All submission fields required
    Given the following "activities" exist:
      ...
      | workshep | All required | Test workshep description | TEST   | workshep1 | 2                  | 2                  |
    ...
    And I set the following fields to these values:
      | Attachment         | mod/workshep/tests/fixtures/moodlelogo.png |
    And I press "Save changes"
  ...
  Scenario: Online text required, file attachment optional
    Given the following "activities" exist:
      | activity | name          | intro                     | course | idnumber  | submissiontypetext | submissiontypefile |
      | workshep | Optional file | Test workshep description | TEST   | workshep1 | 2                  | 1                  |
    And I am on "Test" course homepage
  ...
  Scenario: Online text optional, file attachment required
    Given the following "activities" exist:
      | activity | name          | intro                     | course | idnumber  | submissiontypetext | submissiontypefile |
      | workshep | Optional text | Test workshep description | TEST   | workshep1 | 1                  | 2                  |
    And I am on "Test" course homepage
  ...
  Scenario: Online text only
    Given the following "activities" exist:
      | activity | name      | intro                     | course | idnumber  | submissiontypetext | submissiontypefile |
      | workshep | Only text | Test workshep description | TEST   | workshep1 | 2                  | 0                  |
    And I am on "Test" course homepage
  ...
  Scenario: File attachment only
    Given the following "activities" exist:
      | activity | name      | intro                     | course | idnumber  | submissiontypetext | submissiontypefile |
      | workshep | Only file | Test workshep description | TEST   | workshep1 | 0                  | 2                  |
    And I am on "Test" course homepage
  ...
  Scenario: Neither submission type explicitly required
    Given the following "activities" exist:
      ...
      | workshep | Neither required | Test workshep description | TEST   | workshep1 |
    And I am on "Test" course homepage
