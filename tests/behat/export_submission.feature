@mod @mod_workshep
Feature: Exporting workshep submissions and assessments to a portfolio
  In order to archive my workshep contribution in a personal storage
  As a student or as a teacher
  I need to be able to export a workshep submission and its associated assessments
