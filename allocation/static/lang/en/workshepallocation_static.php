...
/**
 * Strings for component 'workshepallocation_static', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['pluginname'] = 'Allocation Overview';
$string['reviewernumber'] = 'Number of reviewers: %d';
