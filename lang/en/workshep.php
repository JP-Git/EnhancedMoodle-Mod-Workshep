...
$string['legacyallocationplugincron'] = 'Legacy cron workshep allocation';
...
$string['privacy:metadata:aggregatedgradinggrade'] = 'Aggregated grade for all assessments made by the user in the given workshep activity';
...
$string['viewworkshepsummary'] = 'View Enhanced Workshop summary';
...
$string['workshep:exportsubmissions'] = 'Export submissions';
$string['workshep:deletesubmissions'] = 'Delete submissions';
...
$string['switchphase25'] = 'Switch to the calibration phase';
